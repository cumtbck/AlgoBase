...
# Xcode Project Recreation Script

echo "🔧 Recreating Xcode project..."

cd "/Users/planetes/Desktop/Personal/AlgoBase/CLAUDE/frontend"

# Backup the original project file
if [ -f "CLAUDE.xcodeproj/project.pbxproj" ]; then
    cp "CLAUDE.xcodeproj/project.pbxproj" "CLAUDE.xcodeproj/project.pbxproj.backup.$(date +%s)"
    echo "✅ Backup created"
fi
...
/* Begin PBXBuildFile section */
		...
		CLAUDE007 /* SettingsView.swift in Sources */ = {isa = PBXBuildFile; fileRef = CLAUDE006 /* SettingsView.swift */; };
		CLAUDE009 /* DirectoryPickerView.swift in Sources */ = {isa = PBXBuildFile; fileRef = CLAUDE008 /* DirectoryPickerView.swift */; };
		CLAUDE00B /* Assets.xcassets in Resources */ = {isa = PBXBuildFile; fileRef = CLAUDE00A /* Assets.xcassets */; };
		CLAUDE00D /* Preview Assets.xcassets in Resources */ = {isa = PBXBuildFile; fileRef = CLAUDE00C /* Preview Assets.xcassets */; };
...
/* Begin PBXFileReference section */
		...
		CLAUDE006 /* SettingsView.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = SettingsView.swift; sourceTree = "<group>"; };
		CLAUDE008 /* DirectoryPickerView.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = DirectoryPickerView.swift; sourceTree = "<group>"; };
		CLAUDE00A /* Assets.xcassets */ = {isa = PBXFileReference; lastKnownFileType = folder.assetcatalog; path = Assets.xcassets; sourceTree = "<group>"; };
		CLAUDE00C /* Preview Assets.xcassets */ = {isa = PBXFileReference; lastKnownFileType = folder.assetcatalog; path = "Preview Assets.xcassets"; sourceTree = "<group>"; };
...
/* Begin PBXGroup section */
		...
		CLAUDEFFFB /* CLAUDE */ = {
			...
			children = (
				...
				CLAUDE006 /* SettingsView.swift */,
				CLAUDE008 /* DirectoryPickerView.swift */,
				CLAUDE00A /* Assets.xcassets */,
				CLAUDE00E /* Preview Content */,
			);
			path = Sources/CLAUDE;
			sourceTree = "<group>";
		};
		...
		CLAUDE00E /* Preview Content */ = {
			isa = PBXGroup;
			children = (
				CLAUDE00C /* Preview Assets.xcassets */,
			);
...
/* Begin PBXResourcesBuildPhase section */
		CLAUDFFFE /* Resources */ = {
			...
			buildActionMask = 2147483647;
			files = (
				CLAUDE00B /* Assets.xcassets in Resources */,
				CLAUDE00D /* Preview Assets.xcassets in Resources */,
			);
			runOnlyForDeploymentPostprocessing = 0;
		};
...
/* Begin PBXSourcesBuildPhase section */
		CLAUDEABC /* Sources */ = {
			...
			files = (
				...
				CLAUDE007 /* SettingsView.swift in Sources */,
				CLAUDE009 /* DirectoryPickerView.swift in Sources */,
			);
			runOnlyForDeploymentPostprocessing = 0;
		};
...
/* Begin XCBuildConfiguration section */
		CLAUDEFFF7 /* Debug */ = {
			...
			buildSettings = {
				...
				DEVELOPMENT_ASSET_PATHS = "\"Sources/CLAUDE/Preview Content\"";
				ENABLE_PREVIEWS = YES;
...
echo "✅ Xcode project file recreated successfully"
